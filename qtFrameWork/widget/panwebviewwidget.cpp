...
**
****************************************************************************/
#include "panwebviewwidget.h"


   PanWebViewWidget::PanWebViewWidget(QWidget *parent): QWebView(parent), pressed(false), scrolling(false) {
    ...
    void PanWebViewWidget::mousePressEvent(QMouseEvent *mouseEvent) {
    ...
    void PanWebViewWidget::mouseReleaseEvent(QMouseEvent *mouseEvent) {
    ...
    void PanWebViewWidget::mouseMoveEvent(QMouseEvent *mouseEvent) {
